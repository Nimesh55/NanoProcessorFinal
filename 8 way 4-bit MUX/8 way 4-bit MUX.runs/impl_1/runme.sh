...
HD_PWD='D:/Moodle/Computer Architecture/Labs/8 way 4-bit MUX/8 way 4-bit MUX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MUX_8_way_4_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MUX_8_way_4_bit.tcl -notrace
